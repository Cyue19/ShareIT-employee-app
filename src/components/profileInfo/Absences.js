...
export default class Absences extends Component {
    ...
    getStatusLabel(status) {
        switch (status) {
            case "success":
                return (
                    <div className="text-center me-5 pt-1" style={{backgroundColor: "#03C03C", color: "white", height: "25px", width: "80px", borderRadius: "3px", fontSize: "12px"}}>
                        SUCCESS
                    </div>
                    );
            case "canceled":
                return (
                    <div className="text-center me-5 pt-1" style={{backgroundColor: "lightgrey", color: "white", height: "25px", width: "80px", borderRadius: "3px", fontSize: "12px"}}>
                        CANCELED
                    </div>
            ...
            case "pending":
                return (
                    <div className="text-center me-5 pt-1" style={{backgroundColor: "#007FFF", color: "white", height: "25px", width: "80px", borderRadius: "3px", fontSize: "12px"}}>
                        PENDING
                    </div>
                );
            default:
                        ...
                        { profile.absenceRequests.map(request => 
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button style={{padding: "2px 6px"}} type="button" className="btn btn-danger">
