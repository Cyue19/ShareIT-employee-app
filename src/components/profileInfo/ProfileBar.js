    ...
    render() {
        ...
        return (
            <div style={{width: '90%', height: '170px', margin: 'auto', background: "linear-gradient(to bottom left, #3c817a, #19033d)", position: "relative"}}>
                ...
                <button onMouseEnter={() => this.hover()} className="btn btn-primary" style={{position: "absolute", left: "61px", top: "45%", display: isHover ? "" : "none"}} data-bs-toggle="modal" data-bs-target="#pictureModal">Edit</button>
                </ShowIf>
